    ...
    <div className="space-y-6 pb-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="tf-h2 text-[var(--tf-text-primary)]">Booking {booking.bookingRef}</h1>
      ...
      <Tabs defaultValue="details" className="w-full">
        ...
        <TabsContent value="details" className="mt-4 bg-[var(--tf-surface)] rounded-xl border border-[var(--tf-border)] p-6">
          <h3 className="text-lg font-semibold text-[var(--tf-text-primary)] mb-4">Additional Information</h3>
        ...
        <TabsContent value="timeline" className="mt-4 bg-[var(--tf-surface)] rounded-xl border border-[var(--tf-border)] p-6">
