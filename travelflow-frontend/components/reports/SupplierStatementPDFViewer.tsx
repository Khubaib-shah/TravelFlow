...
export default function SupplierStatementPDFViewer({ data }: { data: any }) {
  ...
  return (
    <PDFViewer style={{ width: "100%", height: "100%", border: "none" }}>
      <Document title={`Statement-${data.supplier?.name}`}>
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.detailsContainer}>
            <Text style={styles.supplierName}>{data.supplier?.name || "Supplier"}</Text>
            <Text style={styles.infoText}>{data.supplier?.email} | {data.supplier?.phone}</Text>
            <Text style={styles.infoText}>Contact: {data.supplier?.contactPerson}</Text>
          </View>
