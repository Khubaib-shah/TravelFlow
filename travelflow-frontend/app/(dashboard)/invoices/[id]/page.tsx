    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="tf-h2 text-tf-text-primary">Invoice {id}</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="outline"
            onClick={() => toast.success("Invoice emailed successfully")}
            className="bg-[var(--tf-surface)] text-tf-text-primary print:hidden"
          >
      ...
      <div className="bg-white text-black p-8 md:p-12 rounded-xl shadow-sm border border-tf-border max-w-4xl mx-auto">
        ...
        <table className="w-full text-left border-collapse mb-8">
          <thead>
            <tr className="border-b-2 border-gray-200">
              <th className="py-3 text-sm font-bold text-gray-700 uppercase tracking-wider">
                Description
              </th>
              <th className="py-3 text-sm font-bold text-gray-700 uppercase tracking-wider text-right">
                Qty
              </th>
              <th className="py-3 text-sm font-bold text-gray-700 uppercase tracking-wider text-right">
                Price
